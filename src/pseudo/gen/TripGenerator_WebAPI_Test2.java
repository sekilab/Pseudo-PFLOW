...
public class TripGenerator_WebAPI_Test2 {
    ...
    public TripGenerator_WebAPI_Test2(Country japan, ModeAccessor modeAcs) throws Exception {
        super();
        this.japan = japan;
    ...
    private CloseableHttpClient createHttpClient() {
        ...
        cm.setMaxTotal(16); // Set the maximum number of total open connections.
        cm.setDefaultMaxPerRoute(20); // Set the maximum number of concurrent connections per route, which is 20 here.
...
//						Double mixedcost = mixedfare + mixedtime / 60 * 1000.0;
    ...
    public static void main(String[] args) throws Exception {
        ...
        // create worker
        TripGenerator_WebAPI_Test2 worker = new TripGenerator_WebAPI_Test2(japan, modeAcs);
