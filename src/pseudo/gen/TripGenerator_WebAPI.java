...
public class TripGenerator_WebAPI {
	...
	private PoolingHttpClientConnectionManager createConnManager() {
		...
		cm.setMaxTotal(16); // Adjust this value based on your expected total number of concurrent connections
		cm.setDefaultMaxPerRoute(16); // Adjust per route limits based on your API and use case
		return cm;
	}
