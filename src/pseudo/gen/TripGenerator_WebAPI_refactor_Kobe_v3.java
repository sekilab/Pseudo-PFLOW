 ...
 */
public class TripGenerator_WebAPI_refactor_Kobe_v3 {
    ...
    public TripGenerator_WebAPI_refactor_Kobe_v3(Country japan, Network drm, Network railway) throws Exception {
        super();
        this.drm = drm;
        ...
        private ETransport determineTransportMode(Person person,
            ...
            if (distance > MIN_TRANSIT_DISTANCE) {
                ...
                if (publicTransit) {
                    double mixedfare = 0;
                    if(getRandom() > 0.5){
                        mixedfare = mixedResultsHolder[0].path("fare").asDouble();
                    }
                ...
                if (activities.size() == 1) {
                    ...
                    for (int i = 1; i < activities.size(); i++) {
                        ...
                        if (distance > 0) {
                            ...
                            ETransport nextMode = determineTransportMode(person, purpose, distance, route, mixedparams, mixedResultsHolder);
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i : prefectureCodes) {
            ...
            for (File file : Objects.requireNonNull(actDir.listFiles())) {
                ...
                String tripFileName = outputDir + "trip/" + i + "/trip_" + file.getName().substring(9, 14) + "_v3.csv";
                String trajectoryFileName = outputDir + "trajectory/" + i + "/trajectory_" + file.getName().substring(9, 14) + "_v3.csv";
                ...
                TripGenerator_WebAPI_refactor_Kobe_v3 worker = new TripGenerator_WebAPI_refactor_Kobe_v3(japan, road, railway);
                ...
                getBusRouteStats();
                printBusRouteStats();
                Path out1 = Paths.get(outputDir + "trajectory/" + "large_hiyodori_bus_usage_stats_v3.csv");
                exportBusRouteStatsToCSV(out1);
                Path out2 = Paths.get(outputDir + "trajectory/" + "large_hiyodori_bus_station_usage_stats_v3.csv");
